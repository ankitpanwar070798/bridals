...
class Blog(TimestampModel):
    ...
    featured_image_mobile =  models.ImageField("Thumbnail Image Mobile", help_text="Background image for mobile")
    featured_image_desktop =  models.ImageField("Thumbnail Image Desktop", help_text="Background image for desktop")
    main_image_mobile =  models.ImageField("Main Image Mobile", blank=True, null=True,
                                            help_text="Main image for mobile")
    main_image_desktop =  models.ImageField("Main Image Desktop", blank=True, null=True,
                                             help_text="Main image for desktop")
    tags = models.ManyToManyField(Tag, blank=True, related_name="blogs", help_text="Tags associated with the blog")
